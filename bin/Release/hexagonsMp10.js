...
function coloresMp10(pesos)
{
	...
	if(mp10 < 150)
		cadena = "rgb(0, 128, 0)";
	if(mp10 >= 150 && mp10 <=250)
		cadena = "rgb(255, 255, 0)";
	if(mp10 > 250 && mp10 <=350)
		cadena = "rgb(255,165,0)";
	if(mp10 > 350 && mp10 <=500)
		cadena = "rgb(128,0,128)";
	if(mp10 > 500)
		cadena = "rgb(255,0,0)";
        ...
        for(i = 0; i < width; ++i) {
            for(j = 0; j < height; ++j) {
				if(indice < width*height)
				{
					...
					//lista_Pesos[indiceList]
					ctx.fillStyle = coloresMp10(lista_Pesos[indice]);
					ctx.strokeStyle = coloresMp10(lista_Pesos[indice]);;
					ctx.lineWidth = 1;
					indice+=1;
				}
